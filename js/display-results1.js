...
function LoadRatioScore() {
  ...
  var RatioVote = 0;
	var CountVote = 0;
	var RatioVote = 0;
  var xNameMember1 = "ทัศนีย์ บุญประมวลวิทย์<br>(ต่าย)";
  var xNameMember2 = "นัฐพงษ์ มูขุนทด<br>(อาร์ตี้)";
  var xNameMember3 = "พระชล ปิยะพันธ์<br>(มังกร)";
  var xNameMember4= "นัสนันท์ จันทรศุภวงษ์<br>(การ์ตูน)";
  var xNameMember5= "ศานติ ตินตะชาติ<br>(เจมส์)";
  var xNameMember6= "นัทธพัชญ์ ชาดา<br>(มายด์)";
  var xNameMember7= "ศศิมา จุนเจิม<br>(พอลล่า)";
...
//        GetCountVoteMember.push({ CustomerID: "TV1", RatioVote: Ratio1.toFixed(2) });
      ...
      var RatioMemberVote = (parseInt(SumAllCal)/CountMember)*100 ;
      $("#CheckMemberVote").html(RatioMemberVote.toFixed(2)+"%");  
      ...
      $("#Img1").html('<img src="./img/'+ GetCountVoteMember[0].TVnumber +'.png" style="width:100%;">');  
      $("#Img2").html('<img src="./img/'+ GetCountVoteMember[1].TVnumber +'.png" style="width:100%;">');  
      $("#Img3").html('<img src="./img/'+ GetCountVoteMember[2].TVnumber +'.png" style="width:100%;">');  
      $("#Img4").html('<img src="./img/'+ GetCountVoteMember[3].TVnumber +'.png" style="width:100%;">');  
      $("#Img5").html('<img src="./img/'+ GetCountVoteMember[4].TVnumber +'.png" style="width:100%;">');  
      $("#Img6").html('<img src="./img/'+ GetCountVoteMember[5].TVnumber +'.png" style="width:100%;">');  
      $("#Img7").html('<img src="./img/'+ GetCountVoteMember[6].TVnumber +'.png" style="width:100%;">');  
      ...
      $("#NumberName1").html(GetCountVoteMember[0].NameMember+'');  
      $("#NumberName2").html(GetCountVoteMember[1].NameMember+'');  
      $("#NumberName3").html(GetCountVoteMember[2].NameMember+'');  
      $("#NumberName4").html(GetCountVoteMember[3].NameMember+'');  
      $("#NumberName5").html(GetCountVoteMember[4].NameMember+'');  
      $("#NumberName6").html(GetCountVoteMember[5].NameMember+'');  
      $("#NumberName7").html(GetCountVoteMember[6].NameMember+'');  
